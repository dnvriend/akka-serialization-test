...
class SurnameChangedSerializerTest extends TestSpec {
  "SurnameChanged" should "be serialized to a byte array" in {
    val obj = SurnameChanged("Foo")
